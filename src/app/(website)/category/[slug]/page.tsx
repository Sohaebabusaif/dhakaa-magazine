      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8 py-12">
        {!articles || articles.length === 0 ? (
          <div className="text-center py-20 bg-white rounded-2xl shadow-sm border border-black/5">
            ...
            <h2 className="text-2xl font-bold text-dhakaa-dark mb-2">لا توجد مقالات هنا بعد</h2>
            <p className="text-dhakaa-dark/60">هذا القسم فارغ حالياً. يمكنك إضافة أخبار جديدة من لوحة التحكم لتظهر هنا فوراً.</p>
          </div>
        ) : (
